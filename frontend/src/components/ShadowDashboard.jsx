...
export default function ShadowDashboard({ patientId }) {
  ...
  const [sosLogs, setSosLogs] = useState([
    ...
    { id: 'sos-2', type: 'Unverified Dose Warning', info: 'Atorvastatin 20mg went unverified for 30 minutes. Automated SMS sent.', date: 'July 10, 2026', time: '09:30 PM', urgent: false },
  ]);
  ...
  return (
    <div className="space-y-12 pb-16 font-sans text-xl leading-relaxed text-silver-dark select-none">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-silver-card border-4 border-silver-sos rounded-2xl p-6 shadow-sm flex flex-col justify-between bg-red-50">
          ...
          <span className="text-xs font-bold text-red-500">Requires caregiver review</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="border-2 border-gray-300 rounded-xl p-4">
              ...
              <p className="text-lg font-bold text-silver-dark mt-1">
                Early-stage Dementia, Type 2 Diabetes, Hypertension, Coronary Artery Disease.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-silver-card border-4 border-silver-midtone rounded-3xl p-8 shadow-md space-y-6 lg:col-span-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { name: 'Lisinopril 10mg', dose: '1 pill daily after breakfast', slot: 'Morning', spec: 'Pink / Oval' },
              { name: 'Metformin 500mg', dose: '1 capsule with breakfast', slot: 'Morning', spec: 'White / Capsule' },
